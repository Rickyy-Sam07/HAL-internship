    ...
    <style>
        * {
        ...
        body {
            ...
            background: 
                url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSp80sGiq_93FMl30Chm1v5tzJHwXMdW2X2MQ&s') center center / cover no-repeat fixed,
...
<body>
    ...
    <script>
        ...
        // Enhance login form with interactive features
        function enhanceLoginForm() {
            ...
            passwordInput.addEventListener('keyup', (e) => {
                if (e.getModifierState && e.getModifierState('CapsLock')) {
                    if (!capsLockWarning) {
                        ...
                        capsLockWarning.innerHTML = 'WARNING: Caps Lock is ON';
                        ...
                        `;
                        passwordWrapper.appendChild(capsLockWarning);
                    }
                } else {
                    if (capsLockWarning) {
            ...
            // Form will submit to authenticate.jsp server-side
        ...
        function addInputIcons() {
            ...
            usernameInput.style.paddingLeft = '50px';
            passwordInput.style.paddingLeft = '50px';

            usernameInput.parentElement.insertBefore(usernameIcon, usernameInput);
            passwordInput.parentElement.insertBefore(passwordIcon, passwordInput);
        }

        // Form submits to authenticate.jsp server-side
        // Server handles authentication and redirect
    </script>
</body>
</html>
